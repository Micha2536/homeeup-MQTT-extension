...
import { SimpleMQTTPluginHumidi } from "./plugins/SimpleMQTTPluginHumidi";
import { VorwerkKoboldPlugin } from "./plugins/VorwerkKoboldPlugin";

const pluginPresets = { SimpleHTTPPlugin, SimpleCMDPlugin, FritzBoxPlugin, SimpleMQTTPluginHumidi, SimpleMQTTPluginMotion, SimpleMQTTPluginDoor, SimpleMQTTPlugin, VorwerkKoboldPlugin };
