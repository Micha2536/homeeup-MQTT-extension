...
const logger = Logger.create('SimpleMQTTPluginHumidi');
const mqtt = require('mqtt')
import { PluginInterface } from "./PluginInterface";
import { HMWDS40THI } from "../devices/HMWDS40THI";

export class SimpleMQTTPluginHumidi implements PluginInterface {

    name: String = 'SimpleMQTTPluginHumidi';
    devices = [];
    ...
    init(p) {
        ...
        let device = new HMWDS40THI(p.deviceName);
